$('.edit-product-button').on('click', function() {
    ...
    $('<form method="POST" action="/products/edit/'+ productId +'/" enctype="multipart/form-data"><input type="hidden" name="csrfmiddlewaretoken" value="' + csrf + '"><div class="wrapper"><input type="text" id="id_name" name="product-name" placeholder="Product Name" class="mb-0 form-control product-name-secondary edit-product-field" value="'+ productName.text() +'" required><div class="validation">*</div></div><div class="wrapper"><input id="id_price" placeholder="Price" type="number" step="0.01" name="price" class="mb-0 form-control product-price edit-product-field" value="'+ productPrice.text().replace('$', '') +'" required><div class="validation">*</div></div><div class="wrapper"><select id="id_category" name="category" class="form-control dropdown edit-product-field category-edit-product-field"></select></div><div class="wrapper"><input type="number" placeholder="Inventory" name="inventory" min="0" class="form-control edit-product-field" value="'+ productInventory +'" id="id_inventory" required><div class="validation"></div></div><div class="wrapper"><textarea id="id_description" placeholder="Description" cols="40" rows="4" name="product-description" class="mb-0 form-control product-description edit-product-field" required>'+productDescription.text()+'</textarea><div class="validation">*</div></div><button type="button" class="btn btn-secondary edit-products-button cancel-edit-product">Cancel</button><button class="btn btn-primary edit-products-button" type="submit">Save Changes</button></form>').appendTo(productContainer);
